...
_OVERRIDES = {
    "panegyric": (
        ...
        "A la profesora que se jubilaba la despidieron con un panegírico de sus estudiantes más cercanos.",
        "todo, entero",
        "asamblea, reunión",
    ),
    "pneumatic": (
        ...
        "Los frenos neumáticos silbaron cuando el autobús se detuvo en la acera.",
    ...
    "unpropitious": (
        ...
        "Cielo gris y batería del auto muerta hicieron un arranque poco propicio para el viaje por carretera.",
        "no",
        "favorable, gracioso",
    ),
    "garrulous": (
