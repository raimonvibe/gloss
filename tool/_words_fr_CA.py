...
_REPLACEMENTS = (
    ("e-mails", "courriels"),
    ("e-mail", "courriel"),
    ("un week-end", "une fin de semaine"),  # the gender goes with it
...
_OVERRIDES = {
    "pneumatic": (
        ...
        "Les freins pneumatiques sifflèrent quand l’autobus s’arrêta au bord du trottoir.",
        "vent, souffle, esprit",
        "relatif à",
    ),
    "unpropitious": (
        ...
        "Ciel gris et batterie à plat firent un départ peu propice pour la virée en auto.",
        "ne pas",
    ...
    "garrulous": (
        ...
        "Le chauffeur de taxi loquace nous a raconté toute sa vie avant même qu’on ait quitté l’aéroport.",
        "bavarder, jacasser",
        "enclin à",
    ),
    "prerogative": (
        ...
        "Choisir la destination des vacances familiales, c’est la prérogative de Papy, et tout le monde le sait.",
        "avant",
        "demander, voter",
    ),
    "expatiate": (
        ...
        "Parlez-lui d’autos d’époque et il va disserter pendant une bonne heure.",
        "hors",
        "espace",
    ),
    "cant": (
        ...
        "Il en avait assez du verbiage pieux d’entreprise sur la « famille », dans une compagnie qui ne donnait jamais de congé.",
    ...
    "pedantic": (
        ...
        "Ça paraissait un peu pédant de chicaner sur « who » versus « whom » dans un texto.",
    ...
    "slake": (
        ...
        "Un verre d’eau froide étancha sa soif après la longue randonnée.",
        "lâche, relâché",
        "détendre, calmer",
    ),
}
