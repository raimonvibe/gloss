...
class AppLocalizationsKk extends AppLocalizations {
  ...
  @override
  String get studyCaption => 'оқу, дауыс және жарық';

  @override
  String get readingSection => 'Оқу';

  @override
  String get readingCaption => 'бет қалай жатыр';

  @override
  String get textSize => 'Мәтін өлшемі';

  @override
  String get textSizeSample => 'Edulcorate — тәттілеу, жұмсарту.';

  @override
  String get smaller => 'Кішірек';

  @override
  String get larger => 'Үлкенірек';

  @override
  String get autoplayPronunciation => 'Ашылғанда сөзді дауыстап оқу';

  @override
  String get reduceMotion => 'Әшекейлерді тыныштандыру';

  @override
  String get reduceMotionCaption => 'азырақ өрнек пен өтпелі түс';

  @override
  String get voiceSection => 'Дауыс';

  @override
  String get voiceCaption => 'Gloss қалай дауыстап оқиды';

  @override
  String get chooseVoice => 'Дауыс';

  @override
  String get voiceDefault => 'Сізге таңдалған';

  @override
  String get noOtherVoices =>
      'Бұл құрылғыда басқа ағылшын дауыстары орнатылмаған.';

  @override
  String get speechPace => 'Қарқын';

  @override
  String get slower => 'Баяуырақ';

  @override
  String get faster => 'Жылдамырақ';

  @override
  String get hearIt => 'Тыңдау';

  @override
  String get lightSection => 'Жарық';

  @override
  String get lightCaption => 'пергамент немесе шам жарығы';

  @override
  String get themeSystem => 'Құрылғы бойынша';

  @override
  String get themeLight => 'Пергамент';

  @override
  String get themeDark => 'Шам жарығы';

  @override
  String get tongueSection => 'Тіл';

  @override
  String get aboutSection => 'Қолданба туралы';

  @override
  String get aboutCaption => 'қалай жасалғаны';
  ...
  @override
  String get openLicences => 'Ашық бастапқы код лицензиялары';

  @override
  String get shareGloss => 'Gloss-пен бөлісу';

  @override
  String get followTheMaker => 'Авторға жазылыңыз';

  @override
  String couldNotOpenLink(String label) {
    return '$label ашылмады.';
  }

  @override
  String readExplanationsIn(String language) {
    return 'Түсіндірмелерді $language тілінде оқу';
  }

  @override
  String get readExplanationsCaption => 'Сөздің өзі әрқашан ағылшынша оқылады.';

  @override
  String noVoiceInstalled(String language) {
    return 'Бұл құрылғыда $language дауысы орнатылмаған.';
  }

  @override
  String get memorySection => 'Жады';

  @override
  String get memoryCaption => 'Gloss нені сақтайды';

  @override
  String get forgetProgress => 'Ілгерілеуімді ұмыту';

  @override
  String get forgetProgressBody =>
      'Сіз зерттеген сөздердің белгісі алынады. Сақталған сөздеріңіз қалады.';

  @override
  String get clearSavedWords => 'Сақталған сөздерді тазалау';

  @override
  String get clearSavedWordsBody =>
      'Сіз сақтаған сөздер жойылады. Ілгерілеуіңіз қалады.';

  @override
  String get cancel => 'Бас тарту';

  @override
  String get forget => 'Ұмыту';

  @override
  String get clear => 'Тазалау';

  @override
  String get progressForgotten => 'Ілгерілеу ұмытылды.';

  @override
  String get savedWordsCleared => 'Сақталған сөздер тазаланды.';

  @override
  String get contactTitle => 'Жасаушыға жазыңыз';

  @override
  String get contactCaption => 'хат, қаласаңыз';

  @override
  String get contactBlurb =>
      'Gloss-ты бір адам жасайды. Жетіспеген сөз, тапқан қатеңіз, ұнаған жол — бәрі бір үстелге келеді.';

  @override
  String get contactLetterSection => 'Хат';

  @override
  String get contactName => 'Атыңыз';

  @override
  String get contactNameHint => 'Сізге қалай жүгінетін ат';

  @override
  String get contactEmail => 'Электрондық поштаңыз';

  @override
  String get contactEmailHint => 'Жауап сізді табатын жер';

  @override
  String contactEmailTypo(String domain) {
    return '$domain дегіңіз келді ме?';
  }

  @override
  String get contactReason => 'Жазу себебі';

  @override
  String get reasonWord => 'Қосуға болатын сөз';

  @override
  String get reasonProblem => 'Бірдеңе дұрыс емес';

  @override
  String get reasonQuestion => 'Сұрақ';

  @override
  String get reasonPraise => 'Пікір';

  @override
  String get reasonOther => 'Басқа нәрсе';

  @override
  String get contactPriority => 'Қаншалықты шұғыл';

  @override
  String get priorityLow => 'Төмен';

  @override
  String get priorityNormal => 'Қалыпты';

  @override
  String get priorityHigh => 'Жоғары';

  @override
  String get contactMessage => 'Хабарыңыз';

  @override
  String get contactMessageHint => 'Қалағаныңызша ұзақ немесе қысқа жазыңыз…';

  @override
  String get contactHumanCheck => 'Жібермес бұрын бір сөз';

  @override
  String contactHumanQuestion(String word) {
    return 'Қай мағына $word сөзіне тиесілі?';
  }

  @override
  String get contactHumanRetry => 'Ол емес. Міне, басқа сөз.';

  @override
  String get contactDetails => 'Қолданба мәліметтерін қоса жіберу';

  @override
  String get contactDetailsCaption =>
      'Нұсқа, тіл, жарық және мәтін өлшемі — қате тезірек табылады.';

  @override
  String get contactSend => 'Хатты жіберу';

  @override
  String get contactCopyLetter => 'Хатты көшіру';

  @override
  String get contactDraftRestored => 'Мұнда жіберілмеген хат күтіп тұрған.';

  @override
  String get contactNoMailApp =>
      'Ешбір пошта қолданбасы жауап бермеді, хат алмасу буферінде қалды.';

  @override
  String get contactNeedName => 'Ат, жауап кімге жүгінетінін білуі үшін.';

  @override
  String get contactNeedEmail => 'Жауап жете алатын мекенжай.';

  @override
  String get contactNeedMessage => 'Кемінде бір-екі жол.';

  @override
  String get contactSent => 'Хатыңыз жолда. Рақмет.';

  @override
  String get contactSendFailed =>
      'Хат қазір жіберілмеді. Ол алмасу буферінде және осында сақталды.';

  @override
  String get contactSendByMail => 'Оның орнына пошта қолданбасын пайдаланыңыз';
}
